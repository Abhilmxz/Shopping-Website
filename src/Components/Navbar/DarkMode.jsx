...
import DarkMod from "../../assets/website/dark-mode-button.png";

const DarkMode = () => {
    // DARKMODE ICON IMG ADDING
    const [theme,setTheme]=React.useState(
     localStorage.getItem("teme")? 
  ...
  return (
    <div className='relative'>
      ...
      <img src={LightMode} alt="" onClick={()=> setTheme(theme==="light" ? "dark" : "light")}
      ...
      <img src={DarkMod} alt="" onClick={()=> setTheme(theme==="light" ? "dark" : "light")}
      className='w-12 
      cursor-pointer 
